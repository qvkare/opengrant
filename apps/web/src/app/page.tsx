...
function APICard({ api }: { api: ApiItem }) {
  return (
    <Card className="hover:border-black/30 transition-colors">
      <CardHeader>
        <div className="flex items-start justify-between">
          ...
          {api.category && (
            <span className="px-2 py-1 rounded-lg text-xs font-medium bg-muted">
              {api.category}
            </span>
          )}
        </div>
...
export default function HomePage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-8">
      ...
      {/* CTA Section */}
      <div className="mt-16 text-center py-12 bg-gray-50 border border-gray-100 rounded-xl">
