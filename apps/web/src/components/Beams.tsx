...
function extendMaterial(
  ...
  const defaults = new BaseMaterial((cfg.material as ConstructorParameters<typeof THREE.MeshStandardMaterial>[0]) || {});
  ...
  const mat = new THREE.ShaderMaterial({
    ...
    fragmentShader: frag,
    lights: true,
    fog: !!(cfg.material as Record<string, unknown> | undefined)?.fog,
  });
